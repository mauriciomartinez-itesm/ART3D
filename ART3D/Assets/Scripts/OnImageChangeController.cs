 ...
 * detectar una imagen/target. En cada frame se ejecuta la funcion InImageChange() 
 ...
 * en el script BundleLoader).
 */

public class OnImageChangeController : MonoBehaviour
{
    ...
    private bool FirstPass = true; // Se asegura que solo se ejecute 1 vez el bloque de codigo mientras se esta viendo la imagen.
